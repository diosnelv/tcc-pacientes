...
class PasswordReset extends Notification
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->line(Lang::get('Recibiste este correo porque solicitaste un cambio de contraseña. Haz click en el siguiente enlace'))
            ...
            ->line(Lang::get('Si no solicitaste un cambio de contraseña, ignora este correo.')
            );
    }
